...
<TD vAlign=top width=196>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    <TBODY>
                    <TR>
                      <TD background="lyshand_files/index_zlm.jpg" height="35" align="left">
                      <font color="white"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户登录</strong></font></TD></TR>
                    <TR>
                      <TD background=lyshand_files/index_zlmbj.jpg 
                        align=middle>
                        
                          <form name="form1" method="post" action="/lyshand/lyshand?ac=mlogin">
                        ...
                        width="90%" align=center>
                          ...
                          <TR>
                            ...
                            background=lyshand_files/index_dx.jpg 
                          align=left></TD></TR>
...
<input type="button" value="注册" style="border:2px" onClick="window.location.replace('regedit.jsp')" /></TD>
                    ...
                    <TR>
                      <TD align=left height="41" background="lyshand_files/index_zlm1.jpg" >
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="white">联系我们</font></strong>
                      
                      </TD></TR>
                    <TR>
                      <TD background=lyshand_files/index_zlmbj1.jpg 
                    ...
                    <TR>
                      <TD height=62 background=lyshand_files/index_zlmbj1.jpg 
                      align=middle>
                      ...
                      <A 
                        ...
                        src="lyshand_files/index_zlm2.jpg" width=186 
