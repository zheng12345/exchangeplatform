...
<TABLE border=0 cellSpacing=0 cellPadding=0 width=1002 align=center>
          ...
          <TD vAlign=top>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR>
                ...
                <form action="/lyshand/lyshand?ac=regmember" onSubmit="return check();" method="post" name="f1" enctype="multipart/form-data" >
                <TABLE 
  ...
  window.location.replace("/lyshand/fxiang.jsp?id=<%=id%>");
  </script>
  <%
  }
   %>                             
