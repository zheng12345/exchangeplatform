...
alert("注册成功");
window.location.replace("/lyshand");
</script>
<%  
}
                    ...
                    <TR>
                      <TD><TABLE border=0 cellSpacing=0 cellPadding=0 
                          ...
                          <TBODY>
                            ...
                            <TR>
                              <TD width=228 background="lyshand_files/ny_y3.jpg" height="37" align="left">
                              
                             <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户注册</strong>                              </TD>
                              <TD 
                                background=lyshand_files/ny_ybj.jpg>&nbsp;</TD>
                            </TR>
                          </TBODY>
                      </TABLE></TD>
                    </TR>
                          ...
                          <TBODY>
                            <TR>
                              <TD class=css height=32 
                                background=lyshand_files/ny_xt.jpg width="23%" 
                                align=center>用户名</TD>
                              <TD class=css height=32 
                                background=lyshand_files/ny_xt.jpg width="77%" 
                                align=left>
...
<TR>
                              <TD class=css height=32 
                                background=lyshand_files/ny_xt.jpgg width="23%" 
                                align=center>头像</TD>
                              <TD class=css height=32 
                                background=lyshand_files/ny_xt.jpgg width="77%" 
                                align=left>
...
<script language=javascript src='/lyshand/js/My97DatePicker/WdatePicker.js'></script> 
<script language=javascript src='/lyshand/js/ajax.js'></script>
...
<script language=javascript src='/lyshand/js/My97DatePicker/WdatePicker.js'></script>
<script language=javascript src='/lyshand/js/popup.js'></script>
<script language=javascript src='/lyshand/js/ajax.js'></script>
<%@page import="util.Info"%>
<%@page import="util.Info"%> 
<%@page import="java.util.ArrayList"%> 
...
if(usernameobj.value!=""){  
var ajax = new AJAX();
ajax.post("/lyshand/factory/checkno.jsp?table=users&col=username&value="+usernameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
