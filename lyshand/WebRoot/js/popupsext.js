...
function uploadimg()
{
pop("/lyshand/js/uploadimg.jsp","上传图片",300,77)
}


function uploadimg2()
{
pop("/lyshand/js/uploadimg2.jsp","上传图片",300,77)
}

function uploadimg3()
{
pop("/lyshand/js/uploadimg3.jsp","上传图片",300,77)
}

function uploadimg4()
{
pop("/lyshand/js/uploadimg4.jsp","上传图片",300,77)
}


function uploadimg5()
{
pop("/lyshand/js/uploadimg5.jsp","上传图片",300,77)
}


function uploaddoc()
{
pop("/lyshand/js/uploaddoc.jsp","docupload",300,77)
}
...
build:function(){
   ...
   var close='<img id="dialogBoxClose" title="关闭" src=/lyshand/js/dialogclose.gif  />';
