...
<BODY>
        ...
        <TR>
          <TD bgColor=#006699 height=28 align=middle><SPAN class=bold_txt><A 
            style="CURSOR: hand" 
            onclick="this.style.behavior='url(#default#homepage)';this.setHomePage('http://localhost:8080/lyshand')" 
            href="http://localhost:8080/lyshand">设为首页</A>&nbsp;&nbsp;|&nbsp;&nbsp;<A 
            href="javascript:window.external.AddFavorite('http://localhost:8080/lyshand','企业与企业家')">加入收藏</A> 
           </SPAN></TD></TR>
        <TR>
