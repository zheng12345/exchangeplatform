          ...
          <TD vAlign=top>
            <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR>
                ...
                </div><form  action="ysdd.jsp"  onSubmit="return checkform()"  method="post" name="f1" ><div align="left"> 
                </div><TABLE 
...
<%}%>
//-->
</script> <script language=javascript src='/lyshand/js/My97DatePicker/WdatePicker.js'></script>
