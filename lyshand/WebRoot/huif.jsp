...
var ajax = new AJAX();
ajax.post("/lyshand/lyshand?ac=gethouses&louno="+louno);
...
<%
 ...
 %>
<form action="/lyshand/huif.jsp?id=<%=id %>&f=f" name="f1" method="post" >
...
%>
alert("操作成功");
parent.location.replace("/lyshand/admin/sysuser.jsp");
<%}%>
</script>
