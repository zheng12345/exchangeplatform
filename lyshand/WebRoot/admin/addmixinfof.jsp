...
<script type="text/javascript"  src="/lyshand/fckeditor/fckeditor.js"></script>
 <script language="javascript">
 function fckinit()
 {
   var of = new FCKeditor("content");
		of.BasePath="/lyshand/fckeditor/";
		of.Height = "300";
...
<body onload="fckinit();">
<form action="/lyshand/lyshand?ac=addmixinfof" name="f1" method="post" >
