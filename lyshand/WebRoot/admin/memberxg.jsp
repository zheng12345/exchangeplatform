...
%>
<body>
<form  action="memberxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
...
<script langulyshandcript src='/greensite/js/My97DatePicker/WdatePicker.js'></script> 
<script langlyshandscript src='/greensite/js/ajax.js'></script> 
<script lanlyshandascript src='/greensite/js/popup.js'></script> 
...
var usernameobj = document.getElementById("username");  
if(usernameobj.value!=lyshandar ajax = new AJAX(); 
