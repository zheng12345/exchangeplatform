...
%>
<body>
<form  action="juanztj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
...
<script language=javascrlyshand/greensite/js/My97DatePicker/WdatePicker.js'></script>
<script language=javasclyshand'/greensite/js/popup.js'></script>
<script language=javaslyshand='/greensite/js/ajax.js'></script>
