...
<script type="text/javascript" src="/lyshand/js/popup.js"></script>
<script>
...
%>
<body>
<form  action="wpflxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
...
if(typenameobj.value!=""){  
var ajax = new AJAX(); 
ajax.post("/lyshand/factory/checkno.jsp?table=wpfl&col=typename&value="+typenameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
