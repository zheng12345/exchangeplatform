...
<BODY onLoad="loginform.uname.focus();" background="/lyshand/admin/images/bj.gif">


<script type="text/javascript" src="/lyshand/admin/images/popup.js"></script>
...
<P>&nbsp;</P>
<P>&nbsp;</P>
<FORM name=loginform action="/lyshand/lyshand?ac=login"
method=post>
  <table id=Table1 
...
cellspacing=0 cellpadding=0 width=380 align=center>
    ...
    style="PADDING-RIGHT: 3px; PADDING-LEFT: 3px; FONT-SIZE: 13px; PADDING-BOTTOM: 3px; COLOR: white; PADDING-TOP: 3px; BACKGROUND-COLOR: blue">用户登录　　　　</td>
      ...
      <tr valign=top>
        <td><img height=60 src="/lyshand/admin/images/admin_title.gif" width=378></td>
      </tr>
      <tr>
        <td height="60" 
