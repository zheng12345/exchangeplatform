...
%>
<body>
<form  action="membertj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
...
<script languagelyshandpt src='/greensite/js/My97DatePicker/WdatePicker.js'></script>
<script languaglyshandipt src='/greensite/js/popup.js'></script>
<script langualyshandript src='/greensite/js/ajax.js'></script>
...
var usernameobj = document.getElementById("username");  
if(usernameobj.value!="")lyshandajax = new AJAX();
