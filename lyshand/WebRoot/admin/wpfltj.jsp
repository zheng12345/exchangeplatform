...
%>
<body>
<form  action="wpfltj.jsp?f=f&tglparentid=<%=tglparentid%>"  name="f1" method="post" onSubmit="return checkform()">
...
if(typenameobj.value!=""){  
var ajax = new AJAX();
ajax.post("/lyshand/factory/checkno.jsp?table=wpfl&col=typename&value="+typenameobj.value+"&checktype=insert&ttime=<%=Info.getDateStr()%>") 
