...
%>
<body>
<form  action="juanzxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" method="post" onSubmit="return checkform()">
...
<script language=javalyshandc='/greensite/js/My97DatePicker/WdatePicker.js'></script> 
<script language=javlyshandrc='/greensite/js/ajax.js'></script> 
<script language=jalyshandsrc='/greensite/js/popup.js'></script> 
